...
const slides = [
  {
    src: '/assets/images/banners/dogb1.jpg',
    // Mobile-specific banner (used on small viewports)
    mobileSrc: '/assets/images/banners/mobule dog.png',
    fit: 'contain',
    position: 'center',
    maxWidth: '1000px'
  },
  {
    src: '/assets/images/banners/dogb2.jpg',
    mobileSrc: '/assets/images/banners/mobile cat.png',
    fit: 'contain',
    position: 'right center',
    maxWidth: '1000px'
  },
  {
    src: '/assets/images/banners/dogb3.jpg',
    mobileSrc: '/assets/images/banners/mobile winter.png',
    fit: 'contain',
    position: 'center',
    maxWidth: '1000px'
  },
