    ...
    <footer className="bg-[#071322] text-white">
      ...
      <div className="border-b border-[#0f2230]">
        <div className="container mx-auto px-4 py-6 flex items-center justify-between">
          ...
          <div className="flex-1 text-center px-6 text-sm text-gray-200">
            We’re truly honoured to announce that PET&CO has been crowned with World Branding Award: Brand Of The Year for an unprecedented fifth year in a row, and World Branding Award: Treats Of The Year. Thank you for returning our love for pets with more love, trust, and support.
          </div>
      ...
      <div className="bg-orange-500">
        <div className="container mx-auto px-4 py-3 text-center text-white text-sm">
          © {currentYear}, Earth Paws Private Limited. All Rights Reserved.
        </div>
      </div>
    </footer>
  );
