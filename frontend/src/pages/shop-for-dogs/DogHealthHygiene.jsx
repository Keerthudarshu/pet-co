...
export default function DogHealthHygiene({ initialActive = 'All Dog Health & Hygiene' }) {
  ...
  const routeMap = {
    'All Dog Health & Hygiene': '/shop-for-dogs/dog-health-hygiene/all-dog-health-hygiene',
    'Oral Care': '/shop-for-dogs/dog-health-hygiene/oral-care',
    'Supplements': '/shop-for-dogs/dog-health-hygiene/supplements',
    'Tick & Flea Control': '/shop-for-dogs/dog-health-hygiene/tick-flea-control'
  };
