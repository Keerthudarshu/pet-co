...
export default function DogBedding({ initialActive = 'All Dog Bedding' }) {
  ...
  const routeMap = {
    'Beds': '/shop-for-dogs/dog-bedding/beds',
    'Blankets & Cushions': '/shop-for-dogs/dog-bedding/blankets-cushions',
    'Mats': '/shop-for-dogs/dog-bedding/mats',
    'Personalised Bedding': '/shop-for-dogs/dog-bedding/personalised-bedding',
    'Tents': '/shop-for-dogs/dog-bedding/tents',
    'All Dog Bedding': '/shop-for-dogs/dog-bedding/all-dog-bedding'
  };
